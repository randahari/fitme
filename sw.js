...
const SHELL = [
  ...
  '/fitme/js/coachDecisionSystem/userSafetyProvenanceInterpreter.js',
  '/fitme/js/coachDecisionSystem/readinessStateInterpreter.js',
  '/fitme/js/coachDecisionSystem/activityPreferenceInterpreter.js',
  '/fitme/js/coachDecisionSystem/activityOppositionInterpreter.js',
  ...
  '/fitme/js/repositories/errorLogRepository.js',
  '/fitme/js/repositories/conversationRepository.js',
  ...
  '/fitme/js/coachDecisionSystem/recommendationCategories.js',
  '/fitme/js/coachDecisionSystem/safetyIntegrationPort.js',
  '/fitme/js/coachDecisionSystem/prioritization.js',
  '/fitme/js/coachDecisionSystem/eligibilityEvaluator.js',
  ...
  '/fitme/js/ui/coachConversationPresenter.js',
  '/fitme/js/app.js',
  '/fitme/js/memory.js',
