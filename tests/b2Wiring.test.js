...
test('4. non-engine wrappers were left untouched', () => {
  const preserved = ['_s4_renderProfile', '_s5_callClaude', '_s5_buildCoachSystemPrompt', '_s5_renderSettings_u'];
