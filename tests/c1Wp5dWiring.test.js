...
test('no WP5E-F vocabulary or unexpected files were introduced into js/nutrition/', () => {
  ...
  [appJs, moduleContent].forEach((content) => {
    assert.doesNotMatch(content, /quickLogService|foodController|barcodeFlowController/);
  });
});
